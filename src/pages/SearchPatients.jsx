                ...
                {filtered.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-3">
                      <span
                        className={`px-2 py-1 rounded text-xs font-bold ${p.status === "critical" ? "bg-red-100 text-red-700" : p.status === "active" ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}`}
                      >
                        {p.status}
                      </span>
                    </td>
